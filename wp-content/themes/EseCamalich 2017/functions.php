...
// FORCE CUSTOM POST TYPE CATEGORY TEMPLATE
function wpa57439_category_template( $templates = '' ){
    if( !is_array( $templates ) && !empty( $templates ) ) {
        $templates = locate_template( array( 'archive-projects.php', $templates ), false );
    }
    elseif( empty( $templates ) ) {
        $templates = locate_template( 'archive-projects.php', false );
    }
    else {
        $new_template = locate_template( array( 'archive-projects.php' ) );
